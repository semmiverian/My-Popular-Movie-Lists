...
public class DetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view =  inflater.inflate(R.layout.content_movie_details,container,false);
        Bundle arguments = getArguments();
        if(arguments!=null) {
             movie = arguments.getParcelable("Movie Parceable");
        }
        ...
        movieImage = (AppCompatImageView) view.findViewById(R.id.movieImage);
        title = (AppCompatTextView) view.findViewById(R.id.title);
        rating = (AppCompatTextView) view.findViewById(R.id.rating);
        releaseDate = (AppCompatTextView) view.findViewById(R.id.releaseDate);
        synopsis = (AppCompatTextView) view.findViewById(R.id.synopsis);
        trailerRv = (RecyclerView) view.findViewById(R.id.rvTrailer);
        reviewRv = (RecyclerView) view.findViewById(R.id.rvReview);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        Log.d("asds", "onActivityCreated: "+movie.getPoster_path());
...
//                    .client(client)
            ...
            public void onResponse(Call<TrailerContainer> call, Response<TrailerContainer> response) {
                if(response.isSuccessful()){
                    ...
                    for(Trailer trailer : container.getResults()){
                        Log.d("asd", "onResponse: "+trailer.getName());
        ...
        trailerAdapter.setOnTrailerClick(new TrailerAdapter.OnTrailerClick() {
            ...
            public void onTrailerClick(View view, int position) {
                Toast.makeText(getActivity(), trailerList.get(position).getKey(), Toast.LENGTH_SHORT).show();
